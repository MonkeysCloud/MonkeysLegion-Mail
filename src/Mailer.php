...
class Mailer
{
     ...
     * @param array<string, mixed> $rawConfig The configuration array for the mailer, typically loaded from MLC config or normal php config. This should include driver configurations and other mail settings.
     */
